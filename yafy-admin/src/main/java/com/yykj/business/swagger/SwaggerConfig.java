...
public class SwaggerConfig {
    ...
    public Docket createRestApiForPlatform() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                .groupName("platform")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yykj.business.platform.controller.system"))
    ...
    public Docket createRestApiForYafy() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                .groupName("yafy")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yykj.business.platform.controller.yafy"))
                .paths(PathSelectors.any())
                .build()
                .securitySchemes(securitySchemes())
                .securityContexts(securityContexts());
