...
public class UpYun {
	...
	public static final String DEFAULT_BUCKET_NAME = "image-yykj";
	public static final String DEFAULT_USER_NAME = "developer";
	public static final String DEFAULT_PASSWORD="1qaz2wsx3edc";
