  ...
  <div class="demoTable">
   ...
   <table id="userTables" lay-filter="userFilter"></table>
      ...
      layui.use(['table','element'], function(){
    	  ...
    	  table.render({
    	    elem: '#userTables'
    	    ,url: path + '/platform/order/platformAjaxLod' //数据接口
    	    ,cellMinWidth:60
    	    ,cols: [[ //表头
				  ...
				  ,{title:'商家流水',align:'center',templet:function (row) {
    	  ...
    	  table.on('tool(userFilter)', function(obj){
   		    var data = obj.data;
   		    if(obj.event === 'detail'){
   		       var dateStr=data.dateStr+ ' - '+data.dateStr;
   		      window.location.href = path +"/platform/order/shopTurnover?dateStr="+ dateStr;
   		    }
   		  });
